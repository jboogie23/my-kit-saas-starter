...
<DropdownMenu.Root>
  ...
  <DropdownMenu.Content class="w-56" align="end">
    ...
    <DropdownMenu.Group>
      <DropdownMenu.Item>
        <Button variant="ghost" class="h-6 w-full justify-start p-0" href={route("/settings/profile")}>
          <CircleUser class="mr-1 size-5" />
          Profile
        </Button>
      </DropdownMenu.Item>
      <DropdownMenu.Item>
        <Button variant="ghost" class="h-6 w-full justify-start p-0" href={route("/settings/billing")}>
          <CreditCard class="mr-1 size-5" />
          Billing
        </Button>
      </DropdownMenu.Item>
      <DropdownMenu.Item>
        <Button variant="ghost" class="h-6 w-full justify-start p-0" href={route("/settings/account")}>
