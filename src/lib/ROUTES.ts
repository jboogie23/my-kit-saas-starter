...
const PAGES = {
  ...
  "/order/success": (params?: { sessionId?: string }) => {
    return `/order/success${appendSp({ sessionId: params?.sessionId })}`;
  },
 ...
 */
const ACTIONS = {
  "deleteUser /admin/users": `/admin/users?/deleteUser`,
  "updateUser /admin/users": `/admin/users?/updateUser`,
  "subscribe /order": `/order?/subscribe`,
  "cancel /order": `/order?/cancel`,
  "default /settings/account": `/settings/account`,
  "default /settings/notifications": `/settings/notifications`,
  "default /settings/profile": `/settings/profile`,
...
export type KIT_ROUTES = {
  PAGES: {
    ...
    "/app/dashboard": never;
    "/order": never;
    "/order/canceled": never;
    "/order/checkout": never;
    "/order/error": never;
    "/order/success": never;
    "/settings/account": never;
    "/settings/billing": never;
    "/settings/notifications": never;
    "/settings/profile": never;
    "/settings/security": never;
  ...
  ACTIONS: {
    "deleteUser /admin/users": never;
    "updateUser /admin/users": never;
    "subscribe /order": never;
    "cancel /order": never;
    "default /settings/account": never;
    "default /settings/notifications": never;
    "default /settings/profile": never;
  ...
  Params: { sessionId: never; redirectTo: never; userId: never };
};
